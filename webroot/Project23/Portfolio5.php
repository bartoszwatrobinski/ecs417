    ...
    <body>
        <header>
            ...
            <nav id="navigation" role = "navigation">
                <ul>
                    <li><a href="Portfolio5.php#s1">About Me</a></li>
                    <li><a href="Portfolio5.php#s2">Education and Qualifications</a></li>
                    <li><a href="Portfolio5.php#s4">Experience</a></li>
                    <li><a href="Portfolio5.php#s3">Skills and Achievements</a></li>
                    <li><a href="Portfolio5.php#s5">Projects</a></li>
                    <li><a href="blog.php">Blog</a></li>
                    <input class="button" type="submit" id="logout" value="Logout" name="logout">
                </ul>
            </nav>
            </header> 
            <article id=aboutme1>
